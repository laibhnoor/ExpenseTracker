...
A modern full-stack Expense Tracker that helps users manage their income and expenses, visualize spending patterns, and gain financial insights. The application features a responsive user interface and a robust backend powered by Prisma and PostgreSQL.
